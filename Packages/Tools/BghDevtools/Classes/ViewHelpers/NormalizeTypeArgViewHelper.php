 ...
 * @scope prototype
 */
class NormalizeTypeArgViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper
{
	...
	public function render($type)
	{
		...
		return \F3\BghDevtools\ViewHelpers\NormalizeTypeViewHelper::normalizeEntityClassName($packageKey, $subpackage, $namespace, $type, '');
	}
