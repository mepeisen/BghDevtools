...
/**
 * view helper to calculate the name of the getter
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class EntityGetterViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper
{
	...
	{
		return 'get'.ucfirst($attribute->getName());
	}
