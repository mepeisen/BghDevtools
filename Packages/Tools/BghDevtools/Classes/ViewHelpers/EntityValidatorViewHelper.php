...
/**
 * view helper to calculate the name of the validator
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class EntityValidatorViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper
{
	...
	{
		return 'validate'.ucfirst($attribute->getName());
	}
