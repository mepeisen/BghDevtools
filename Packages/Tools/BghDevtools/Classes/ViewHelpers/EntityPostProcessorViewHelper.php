...
/**
 * view helper to calculate the name of the post processor
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class EntityPostProcessorViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper
{
	...
	{
		return '_'.$attribute->getName().'Changed';
	}
