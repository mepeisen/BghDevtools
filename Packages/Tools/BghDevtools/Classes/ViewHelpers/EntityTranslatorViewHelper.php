...
/**
 * view helper to calculate the name of the translator
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class EntityTranslatorViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper
{
	...
	{
		return 'translate'.ucfirst($attribute->getName());
	}
