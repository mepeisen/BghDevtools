...
/**
 * Service method return definition
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 */
class DomainServiceMethodReturn extends \F3\BghDevtools\Domain\DocumentedElement
{
	...
	{
		return 'Service-Method-Return-Definition';
	}
	...
	protected function validate()
	{
		...
		if ($this->type === false)
		{
			throw new \F3\BghDevtools\Domain\Service\Exception("Error service service method return. Missing type", 1286873572);
		}
	}
