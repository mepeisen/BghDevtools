...
/**
 * Repository method return definition
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class DomainRepositoryMethodReturn extends \F3\BghDevtools\Domain\DocumentedElement
{
	...
	{
		return 'Repository-Method-Return-Definition';
	}
	...
	protected function validate()
	{
		...
		if ($this->type === false)
		{
			throw new \F3\BghDevtools\Domain\Model\Exception("Error reading repository method return. Missing type", 1286873572);
		}
	}
