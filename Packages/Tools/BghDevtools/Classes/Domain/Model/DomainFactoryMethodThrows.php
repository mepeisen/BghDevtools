...
/**
 * Factory method throws definition
 *
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 * @scope prototype
 */
class DomainFactoryMethodThrows extends \F3\BghDevtools\Domain\DocumentedElement
{
	...
	{
		return 'Factory-Method-Throw-Definition';
	}
	...
	protected function validate()
	{
		...
		if ($this->type === false)
		{
			throw new \F3\BghDevtools\Domain\Model\Exception("Error reading factory throws return. Missing type", 1286873572);
		}
	}
